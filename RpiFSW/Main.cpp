...
#include <RpiFSW/Top/RpiFSWTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    RpiFSW::setupTopology(inputs);
    RpiFSW::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    RpiFSW::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
