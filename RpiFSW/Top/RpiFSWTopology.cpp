...
void configureTopology()
{
    ...
    rpi_fileDownlink.configure(FILE_DOWNLINK_TIMEOUT, FILE_DOWNLINK_COOLDOWN, FILE_DOWNLINK_CYCLE_TIME,
    ...
    rpi_health.setPingEntries(pingEntries, FW_NUM_ARRAY_ELEMENTS(pingEntries), HEALTH_WATCHDOG_CODE);
...
namespace RpiFSW
{
    void setupTopology(const TopologyState &state)
    {
        ...
        if (rpi_hubDriver.open("/dev/ttyS0", Drv::LinuxUartDriver::UartBaudRate::BAUD_115K, Drv::LinuxUartDriver::NO_FLOW,
