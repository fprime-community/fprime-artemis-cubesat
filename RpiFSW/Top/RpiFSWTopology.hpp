...
// Included for access to RpiFSW::TopologyState and RpiFSW::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * RpiFSW::TopologyState see: RpiFSWTopologyDefs.hpp.
 *
