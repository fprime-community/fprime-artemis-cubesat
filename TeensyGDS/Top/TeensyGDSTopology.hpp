...
// Included for access to TeensyGDS::TopologyState and TeensyGDS::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * TeensyGDS::TopologyState see: TeensyGDSTopologyDefs.hpp.
 *
