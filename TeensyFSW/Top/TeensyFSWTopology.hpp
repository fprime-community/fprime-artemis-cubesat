...
// Included for access to TeensyFSW::TopologyState and TeensyFSW::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * TeensyFSW::TopologyState see: TeensyFSWTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TeensyFSW::TopologyState see: TeensyFSWTopologyDefs.hpp.
 *
