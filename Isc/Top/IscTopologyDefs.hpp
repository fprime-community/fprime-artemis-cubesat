...
#include "Isc/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `Isc::TopologyState`. Only the type
