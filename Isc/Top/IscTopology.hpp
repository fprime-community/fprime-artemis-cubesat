...
// Included for access to Isc::TopologyState and Isc::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Isc/Top/IscTopologyDefs.hpp>

// Remove unnecessary Isc:: qualifications
using namespace Isc;
namespace Isc {
/**
 ...
 * Isc::TopologyState see: IscTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Isc::TopologyState see: IscTopologyDefs.hpp.
 *
