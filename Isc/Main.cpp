...
int main(int argc, char* argv[]) {
    ...
    Isc::setupTopology(inputs);
    Isc::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    Isc::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
